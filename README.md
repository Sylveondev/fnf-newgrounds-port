...
<br>
<p align="center">ℹ️ INFO: REPLACEMENT BRANCH! ℹ️<br>The new branch <strong>will be a direct port</strong> done via reverse engineering.<br>Please check <a href="https://github.com/AngelDTF/FNF-NewgroundsPort/tree/reverse-engineered">AngelDTF/FNF-NewgroundsPort (reverse-engineered branch)</a> to see if the direct port is finished!</p>
